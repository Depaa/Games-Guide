...
(5, '2017-12-28', 'AMD Radeon Adrenalin Edition 17.12.2 ora disponibili ', 'Depaa',' <span lang="en"> <abbr title="Advanced Micro Devices">AMD</abbr> </span> ha pubblicato una nuova versione dei <span lang="en">driver</span> per le schede video dotate delle sue <span lang="en"> <abbr title="Graphics Processing Un">GPU</abbr> </span>. 
...
(6, '2017-12-29', 'Switch: Nintendo ha rimosso NES Golf dal firmware della console', 'Peachka',' Come gi&agrave; saprete, diverso tempo fa era stata scoperta la presenza di un emulatore <span lang="en"> <abbr title="Nintendo Entertainment System">NES</abbr> </span> ed il titolo Golf all&rsquo;interno del <span lang="en">firmware</span> di <span lang="en">Switch</span>. 
...
(7, '2017-12-30', 'The Crew 2: Sono aperte ore le iscrizioni alla Beta', 'Gionny','Nelle scorse ore <span lang="en">Ubisoft</span> ha ufficialmente aperto le iscrizioni alla fase Beta di <span lang="en">The Crew</span> 2 su <span lang="en">PlayStation</span> 4, <span lang="en">Xbox One</span> e PC.
