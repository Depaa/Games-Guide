...
CREATE TABLE `Videogiochi` (
  ...
  `Nome` varchar(100) NOT NULL,
  `Data` date NOT NULL,
  `Genere1` int(4) NOT NULL,
  `Genere2` int(4) DEFAULT NULL,
  `Genere3` int(4) DEFAULT NULL,
