...
(1, '2017-11-30', 'Presentata Xbox One X ', 'Depaa', '<span lang="en">Xbox One</span> X &egrave;, anzitutto, un piccolo miracolo di ingegneria e progettazione. La <span lang="en">console</span> se ne esce dalla scatola pronta a stupire l&rsquo;utente grazie alle dimensioni estremamente contenute, addirittura pi&ugrave; ridotte della candida &ldquo;sorellina minore&rdquo;. Il <span lang="en">form factor</span> &egrave; simile a quello di <span lang="en">Xbox One</span> S: essenziale, pulito, squadrato, ma decisamente pi&ugrave; elegante rispetto a quello della versione <span lang="en">&ldquo;fat&rdquo;</span>. Il blocco centrale della macchina ne sovrasta uno pi&ugrave; piccolo, mettendo in risalto il vano del disco. Spariscono le forature della parte superiore, anche per via di una revisione integrale del sistema di raffreddamento (che adesso sfrutta la dissipazione a camera di vapore). Le superfici nere, leggermente satinate, sono piacevolissime alla vista, e la compattezza dell&rsquo;assemblaggio rende la macchina un piccolo gioiello da esporre fieramente in salotto. Che <span lang="en">Microsoft</span> sia riuscita ad infilare il suo &ldquo;mostro di potenza&rdquo; in uno <span lang="en">chassis</span> cos&igrave; piccolo, insomma, &egrave; un risultato pi&ugrave; che ammirevole, frutto di un processo di ingegnerizzazione veramente incredibile. Qui non si tratta, badate bene, solo di una marcata attenzione per l&rsquo;ottimizzazione degli spazi e la &ldquo;miniaturizzazione&rdquo;, bens&igrave; di uno studio meticoloso del posizionamento di ogni componente, attento ad ogni aspetto: potenza, gestione termica, riduzione del rumore, stile.<span lang="en"> Xbox One</span> X, insomma, si presenta fin da subito come un prodotto premium, ideato per quei giocatori che non vogliono scendere a compromessi su nessun fronte: neppure sul quello estetico e progettuale.', 1, 0, 0, 0, 0, 0, 0, 0, 'XboxOneX.jpg'),
(2, '2017-12-06', 'The Legend Of Zelda: Breath Of The Wild. Premiato come gioco dell&rsquo;anno!', 'Peachka', ' Nuovo importante riconoscimento per <span lang="en">The Legend Of</span> Zelda: <span lang="en">Breath Of The Wild</span>.: questa volta &egrave; <span lang="en">GameSpot USA</span> a premiare l&rsquo;ultima avventura di <span lang="en">Link</span> con il prestigioso premio di <span lang="en">Game of the Year</span>, riservato al miglior gioco dell&rsquo;anno. Per la redazione di <span lang="en">GameSpot USA, Breath of the Wild </span>&egrave; il miglior gioco degli ultimi dodici mesi, nonch&egrave; uno dei migliori titoli di sempre, grazie a un <span lang="en">gameplay</span> di assoluto livello, a una narrazione ineccepibile e ad una direzione artistica di alto profilo. <span lang="en">The Legend Of</span> Zelda: <span lang="en">Breath Of The Wild</span> &egrave; il videogioco pi&ugrave; premiato del 2017, nonch&egrave; il titolo con la media pi&ugrave; alta dell&rsquo;anno su Metacritic, a testimonianza dell&rsquo;ottima accoglienza ricevuta da parte della stampa specializzata. Il gioco &egrave;; stato eletto <span lang="en">Game of the Year</span> ai <span lang="en">The Game Awards</span> dell&rsquo;8 dicembre scorso, riconoscimento importante, inoltre anche <span lang="en">Polygon</span> ha inserito <span lang="en">Zelda Breath of the Wild</span> nella Top 50 dell&rsquo;anno che sta pr terminare. Un grande successo per Nintendo e per <span lang="ja">Eiji Aonuma</span>, il <span lang="en">producer</span> della serie ha affermato recentemente che i lavori sul prossimo gioco di Zelda, sono gi&agrave; iniziati, sebbene sia ancora troppo presto per iniziare a parlarne. Non ci resta dunque che attendere di saperne di pi&ugrave; sul nuovo capitolo della saga.', 0, 0, 0, 1, 0, 0, 0, 0, 'ZBWN.jpg'),
(3, '2017-12-05', 'Uscir&agrave; presto il nuovo God of War', 'Depaa', ' <span lang="en">Sony Interactive Entertainment</span> ha pubblicato un video di <span lang="en">God of War</span> dedicato ad Atreus, il figlio di Kratos, svelando nuovi dettagli e retroscena sulla storia del personaggio. In assenza del padre, Atreus ha continuato a vivere insieme alla madre mentre affinava le proprie abilit&agrave; con l&rsquo;arco, preparandosi cos&igrave; a diventare quel piccolo guerriero che avremo modo di conoscere durante la nuova avventura di Kratos. Tra le altre cose, apprendiamo che Atreus sar&agrave; in grado di ascoltare le voci degli animali nella propria testa, caratteristica che con ogni probabilit&agrave; trover&agrave; diverse applicazioni interessanti anche a livello di <span lang="en">gameplay</span>. Nell&rsquo;attesa che il nuovo <span lang="en">God of War</span> venga pubblicato in esclusiva su <span lang="en">PlayStation</span> 4 nel corso del 2018, vi riproponiamo gli ultimi <span lang="en">screenshot</span> del gioco mostrati nella giornata di ieri. ', 0, 0, 0, 0, 0, 0, 0, 1, 'GO00W4.jpg'),
(4, '2017-12-25', 'Auguri di buone feste dalla redazione di GamesGuide ', 'Aiolos', 'Un altro anno giunge al termine, e noi della redazione di <span lang="en">Games&rsquo; Guide</span> vogliamo augurarvi buone feste e qualche giorno di sano <span lang="en">relax</span> (magari in compagnia dei vostri videogiochi preferiti) in attesa di un promettente 2018. A prescindere da come passerete i prossimi giorni, vi ringraziamo per averci seguito nel corso dell&rsquo;anno, interagendo con noi attraverso commenti e <span lang="en">feedback</span> e aiutandoci a offrirvi contenuti sempre pi&ugrave; ricchi e diversificati. All&rsquo;orizzonte ci sono tante nuove idee, rubriche, approfondimenti e contenuti che speriamo apprezzerete. Nel frattempo...Buone feste!', 1, 1, 1, 1, 1, 1, 1, 1, 'MC.jpg'),
(5, '2017-12-29', 'AMD Radeon Adrenalin Edition 17.12.2 ora disponibili ', 'Depaa', ' <span lang="en"> <abbr title="Advanced Micro Devices">AMD</abbr> </span> ha pubblicato una nuova versione dei <span lang="en">driver</span> per le schede video dotate delle sue <span lang="en"> <abbr title="Graphics Processing Un">GPU</abbr> </span>. <span lang="en"> <abbr title="Advanced Micro Devices">AMD</abbr> Radeon Adrenalin Edition</span> 17.12.2 risolvono alcuni problemi riscontrati dagli utenti con alcuni giochi ed applicazioni, in particolare modo ARK <span lang="en">Survival Evolved<span lang="en">,<span lang="en"> Star Wars Battlefront</span> 2 e <span lang="en">Netflix</span>. Non ci resta che augurare ai nostri lettori buon <span lang="en">download</span> e buon aggiornamento.', 0, 0, 1, 1, 0, 0, 0, 0, 'AMD.jpg'),
(6, '2017-12-30', 'Switch: Nintendo ha rimosso NES Golf dal firmware della console', 'Peachka', ' Come gi&agrave; saprete, diverso tempo fa era stata scoperta la presenza di un emulatore <span lang="en"> <abbr title="Nintendo Entertainment System">NES</abbr> </span> ed il titolo Golf all&rsquo;interno del <span lang="en">firmware</span> di <span lang="en">Switch</span>. A quanto pare, tuttavia, Nintendo ha deciso di eliminare il gioco &ldquo;segreto&rdquo; con uno degli ultimi aggiornamenti del <span lang="en">software</span> di sistema. Infatti, la recente versione 4.0.0, pubblicata qualche settimana fa, ha completamente rimosso tutto il codice eseguibile del gioco, rimpiazzandolo con dati casuali. Al momento non si conosce ancora il motivo per il quale il titolo era presente all&rsquo;interno della <span lang="en">console</span>. La sua rimozione lascia pensare che si potesse trattare solo di codice di prova lasciato erroneamente dai progettisti del sistema.', 0, 0, 0, 1, 0, 0, 0, 0, 'GS.jpg'),
(7, '2017-12-31', 'The Crew 2: Sono aperte ore le iscrizioni alla Beta', 'Gionny', 'Nelle scorse ore <span lang="en">Ubisoft</span> ha ufficialmente aperto le iscrizioni alla fase Beta di <span lang="en">The Crew</span> 2 su <span lang="en">PlayStation</span> 4, <span lang="en">Xbox One</span> e PC. Per la registrazione &egrave; sufficiente recarsi a questo indirizzo, creare un <span lang="en">account Ubisoft</span> (o semplicemente effettuare il <span lang="en">login</span> in con quello gi&agrave; in vostro possesso), scegliere la piattaforma preferita e premere sul pulsante di conferma. I giocatori selezionati riceveranno una <span lang="en">patch</span> pochi giorni prima dell&rsquo;inizio con tutte le informazioni necessarie per ottenere l&rsquo;accesso. Purtroppo, <span lang="en">Ubisoft</span> non ha ancora annunciato la data dell&rsquo;inizio della fase di <span lang="en">testing</span>, n&egrave; tantomeno quella dell&rsquo;uscita del gioco. <span lang="en">The Crew</span> 2, inizialmente previsto per il 16 marzo 2018, &egrave; stato infatti rinviato dalla casa francese a data da destinarsi. Il <span lang="en">team</span> di sviluppo sfrutter&agrave; i prossimi mesi per effettuare sessioni di <span lang="en">testing</span> aggiuntive e raccogliere il <span lang="en">feedback</span> dei giocatori. Il titolo si &egrave; mostrato l&rsquo;ultima volta nel mese di agosto, in occasione della <span lang="en">Gamescom</span> di Colonia.', 1, 1, 0, 0, 1, 0, 1, 1, 'TC2.jpg'),
(8, '2018-01-01', 'Level-5 sta lavorando a un grande progetto per il suo ventesimo anniversario ', 'Depaa', 'Il noto sviluppatore <span lang="en">Level-5 </span>avrebbe alcuni grandi piani per festeggiare il loro ventesimo anniversario. Secondo quanto rivelato da <span lang="ja">Akihiro Hino</span>, <span lang="en"> <abbr title="Chief Executive Officer">CEO</abbr> </span> di <span lang="en">Level-5</span>, la compagnia starebbe lavorando a un titolo molto importante come parte della celebrazione. Nessun dettaglio sul gioco &egrave; ancora emerso <span lang="en">online</span>, ma vale la pena sottolineare che le parole di <span lang="ja">Hino</span> sono apparse nel corso di un&rsquo;intervista con <span lang="ja">Dengeki</span> <span lang="en">PlayStation</span>, cosa che presuppone un progetto destinato alle <span lang="en">console Sony</span>.  ', 0, 0, 0, 0, 1, 0, 0, 0, 'L5.jpg');
...
(1, 'Assassin&rsquo;s Creed: Origins', 'Aiolos', 'La Recensione di Assassin&rsquo;s Creed: Origins, mummia o faraone?', 'Separare il suo nome dalle antipatie personali e dalla negativit&agrave; che fin troppo spesso lo circonda potrebbe essere una necessit&agrave; perch&egrave; molti giocatori ne comprendano il reale valore, eppure la serie <span lang="en">Assassin&rsquo;s Creed </span> possiede ancora oggi una rilevanza a cui buona parte delle altre saghe possono solo aspirare, nata da un brillante misto di accessibilit&agrave; e fascino storico. Stiamo pur sempre parlando dei giochi che hanno introdotto nel genere <span lang="en">action adventure</span> la straordinaria meccanica del  <span lang="en">free running</span>, e la definiamo &ldquo;straordinaria&rdquo; perch&egrave; per un  <span lang="en">game designer</span> concettualizzare e applicare un sistema in grado di rendere il movimento verticale alla portata di tutti &egrave; qualcosa di equiparabile a una visione mistica. <span lang="en">Assassin&rsquo;s Creed Origins</span> &egrave; un  <span lang="en">open world</span> enorme, per offrire un ancor pi&ugrave; riuscito misto di esplorazione, combattimento e libert&agrave; d&rsquo;azione, il tutto all&rsquo;interno di una suggestiva ambientazione egiziana nell&rsquo;era di Cesare e Cleopatra. Oggi, forti di una sessione di prova di qualche giorno a Parigi, cercheremo di capire con voi se l&rsquo;origine degli assassini rappresenta davvero un nuovo inizio per questa iconica serie.', '2017-10-27', 0, 1, 0, 1, 0, 0, 1, 0),
(2, 'Call of Duty: World War II', 'Depaa', 'La Recensione di Call of Duty: WWII, piedi in terra.', 'Se dovessimo guardare solamente i dati di vendita potremmo tranquillamente paragonare <span lang="en">Call of Duty</span> a una macchina inarrestabile, una di quelle vetture talmente perfette da tagliare sempre per prime il traguardo, nonostante intoppi e incidenti di percorso. Nell&rsquo;anno di maggior flessione per il <span lang="en">brand</span>, con un capitolo non particolarmente amato dal pubblico e con un <span lang="en">trailer</span> di lancio che fece registrare ai tempi il record assoluto di <span lang="en">dislike</span> su <span lang="en">Youtube</span>, <span lang="en">Call of Duty</span> &egrave; riuscito comunque a imporsi sul mercato, perdendo forse terreno nei confronti di <span lang="en">Battlefield</span> 1 ma restando saldamente ancorato sul trono. Gi&agrave; tre anni fa per&ograve; i vertici <span lang="en">Activision</span> avevano ben chiaro che il pubblico si stava disaffezionando al <span lang="en">brand</span>, annoiato pi&ugrave; che dal <span lang="en">gameplay</span>, da un <span lang="en">setting</span> futuristico che ormai aveva ben poco altro da dire e da offrire. La soluzione scelta per affacciarsi a questo radicale cambiamento &egrave; stata quella di far un passo indietro e tornare in quella seconda guerra mondiale che mancava dalla scena da ormai troppo tempo. Quest&rsquo;anno, tra le altre cose, della campagna di <span lang="en">Call of Duty</span> e dei suoi contenuti extra se ne &egrave; parlato davvero pochissimo, lasciando che fosse il <span lang="en">multiplayer</span> ad assorbire tutte le attenzioni durante gli eventi e le beta pubbliche. Qualche settimana fa siamo per&ograve; volati a Londra per affondare i denti sul pacchetto completo e oggi torniamo da voi con il verdetto finale per la produzione.', '2017-11-03', 0, 1, 0, 1, 0, 0, 1, 0),
(3, 'Super Mario Odyssey', 'admin', 'La Recensione di Super Mario Odyssey', 'Nonostante sia stato spesso definito come tale, Super Mario <span lang="en">Odyssey</span>, almeno in senso stretto, non &egrave; il seguito di Super Mario 64. Questo nuovo <span lang="en">platform</span> tridimensionale, diretto da <span lang="ja">Kenta Motokura</span> e prodotto da <span lang="ja">Hayashida</span> e <span lang="ja">Koizumi</span>, non si limita a voler rinverdire le meccaniche di Super Mario 64: prende il punto forte di ogni predecessore e lo sfida a duello, il tutto mentre tenta di armonizzare e fondere assieme queste dinamiche tra loro molto diverse. Si ispira all&rsquo;esplorazione del capostipite su Nintendo 64, ripropone le missioni tematiche di Super Mario <span lang="en">Sunshine</span>, eredita la variet&agrave; e gli scherzi gravitazionali di Super Mario <span lang="en">Galaxy</span>, e perfino dall&rsquo;ultimo Super Mario 3D <span lang="en">World</span>, teoricamente cos&igrave; diverso, riprende ritmo e abbondanza di contenuti. Insomma, per dirla alla <span lang="en">Tolkien</span>, &ldquo;un <span lang="en">platform</span> per domarli, un <span lang="en">platform</span> per trovarli, un <span lang="en">platform</span> per ghermirli e nell&rsquo;oscurit&agrave; incatenarli&rdquo;.', '2017-10-27', 0, 0, 0, 0, 0, 1, 0, 0),
(4, 'The Legend of Zelda: Breath of the Wild', 'Peachka', 'La Recensione di The Legend of Zelda: Breath of the Wild', 'Questo ultimo episodio di <span lang="en">The Legend of</span> Zelda &egrave; il gioco pi&ugrave; grande e costoso della storia Nintendo: &egrave; stato sviluppato per cinque anni (dal 2012 al 2016) e ha richiesto, al culmine della lavorazione, l&rsquo;impegno di circa trecento persone, alcune delle quali tra l&rsquo;altro, provenienti da <span lang="en">Monolith Soft </span>. Per trovare un progetto altrettanto ambizioso da parte dell&rsquo;azienda bisogna andare indietro nel tempo di quasi due decenni. Alcuni di voi potrebbero citare Super Mario <span lang="en"> Galaxy </span> ma, l&rsquo;avventura interplanetaria dell&rsquo;idraulico, per quanto sperimentale e straordinaria, ha rappresentato un&rsquo;eccellenza fine a s&egrave; stessa. Al contrario, <span lang="en">Breath of the Wild</span> si &egrave; fatto carico non solo del proprio destino, ma di quello di <span lang="en"> <abbr title="Environmental Product Declaratio">EPD </abbr> </span>: gli enormi tempi richiesti dall&rsquo;elaborazione di un nuovo <span lang="en">engine</span>, comprendente un avanzato motore fisico, saranno ripagati dalla condivisione di questi elementi con altri titoli sviluppati internamente.', '2017-03-03', 0, 0, 0, 0, 0, 1, 0, 0),
...
(6, 'FIFA 18', 'Gionny', 'La Recensione di FIFA 18: sempre il solito?', 'La modalit&agrave; che maggiormente ne ha beneficiato in FIFA 18 &egrave; il ritorno di <span lang="en">Hunter</span>.  Nel secondo capitolo dell&rsquo;epopea calcistica di <span lang="en">Alex Hunter</span> potremo osservare tutta una serie di miglioramenti davvero notevoli, che elevano l&rsquo;esperienza al rango di film interattivo. Grazie al <span lang="en">Frostbite</span>, infatti, non solo ogni filmato di gioco &egrave; incredibile nel suo realismo, con i volti delle diverse <span lang="en">guest star</span> che si alternano sullo schermo perfettamente riprodotti, ma anche tutto il confezionamento delle scene pre e post partita ha subito un netto balzo in avanti. Gli stadi sono riprodotti perfettamente e tutto &egrave; girato con un taglio registico che poco ha da invidiare alle produzioni di <span lang="en">Sky</span> o Mediaset. Oltre al lato estetico, in FIFA 18 sono stati introdotti anche altri miglioramenti come la possibilit&agrave; di modificare il <span lang="en">look</span> di <span lang="en">Hunter</span> o la possibilit&agrave; di incidere su alcune piccole decisioni che il giovane dovr&agrave; prendere durante la nuova stagione calcistica. Decisamente pi&ugrave; impattanti saranno la possibilit&agrave; di giocare a una sorta di FIFA <span lang="en">Street</span> in miniatura (invero piuttosto divertente) o quella di giocare nei panni di altre persone oltre ad Alex. Non entriamo pi&ugrave; nei dettagli per non rovinare la sorpresa.', '2017-09-29', 1, 1, 1, 1, 0, 1, 1, 0),
...
(6, 'FIFA 18', '2017-09-29', 'Sport', NULL, NULL, 3, NULL, '<span lang="en"> <abbr title="PlayStation 3">Ps3</abbr>, <abbr title="PlayStation 4">Ps4</abbr>, Xbox 360, Xbox One, <abbr title="Nintendo Switch">NSwitch</abbr>, Windows</span>', 1, 1, 1, 1, 0, 1, 1, 0, 'FIFA 18 attenua il confine tra il mondo reale e virtuale dando vita a eroi, squadre e atmosfere del gioco pi&ugrave; bello del mondo. Introduce la pi&ugrave; grande innovazione al sistema di gioco nella storia della serie, la tecnologia d&rsquo;animazione <span lang="en">Real Player</span>, un sistema innovativo che sblocca un nuovo livello di reattivit&agrave; e di personalit&agrave; dei giocatori. Ora Cristiano Ronaldo e gli altri campioni si muovono esattamente come sul campo reale.'),
