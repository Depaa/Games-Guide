...
DROP VIEW IF EXISTS RecensioneMancante; 
CREATE VIEW RecensioneMancante AS 
...
DROP VIEW IF EXISTS MaggiorCommentiUser; 
CREATE VIEW MaggiorCommentiUser AS 
...
DROP VIEW IF EXISTS EsclusiveGiochi; 
CREATE VIEW EsclusiveGiochi AS 
...
DROP VIEW IF EXISTS GiochiCasaEditrice; 
CREATE VIEW GiochiCasaEditrice AS 
...
DROP VIEW IF EXISTS MigliorValutazione; 
CREATE VIEW MigliorValutazione AS 
...
DROP VIEW IF EXISTS RecensioneMedia; 
CREATE VIEW RecensioneMedia AS 
...
DROP VIEW IF EXISTS NotizieAdminPiatta; 
CREATE VIEW NotizieAdminPiatta AS 
...
DROP VIEW IF EXISTS CommentiRecensione;
CREATE VIEW CommentiRecensione AS 
