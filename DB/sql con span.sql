...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2018 at 12:01 PM
...
(1, 'Presentata <span lang="en">Xbox One</span> X ', '2017-11-30', '10:30:00', 'La nuova Xbox One X spacca, è molto più performante di tutte le console Sony, sommate tra loro ovviamente ;) e poi, diciamoci la verità, le esclusive della sony non sono nemmeno così carine :sad:', 'Nikocister'),
(2, 'Auguri di buone feste dalla redazione di <span lang="en">GamesGuide</span> ', '2018-01-03', '04:35:30', 'cawabonga', 'admin'),
(3, 'Uscir&agrave; presto il nuovo <span lang="en">God of War</span>', '2018-01-03', '04:35:36', 'cawabonga2', 'admin'),
(4, '<span lang="en">The Crew </span>2: Sono aperte ore le iscrizioni alla Beta', '2018-01-05', '07:09:17', 'sdfgffds', 'admin');
...
(1, 'La Recensione di <span lang="en">The Legend of</span> Zelda: <span lang="en">Breath of the Wild</span> ', '2017-11-30', '10:30:00', 'molto bella la grafica, ho perso un semestre a causa di questo gioco', 'Nikocister'),
(2, 'La Recensione di Super Mario <span lang="en">Odyssey</span>', '2017-11-30', '01:30:00', 'molto bella la grafica, ho perso un semestre a causa di questo gioco', 'Nikocister'),
(3, 'La Recensione di FIFA 18: sempre il solito?', '2018-01-04', '01:32:18', 'commmentono', 'admin'),
(4, 'La Recensione di <span lang="en">Crash Bandicoot</span>, un sogno che diventa realt&agrave;', '2018-01-04','01:32:22', 'asdasdadsa', 'admin'),
(5, 'La Recensione di <span lang="en">Crash Bandicoot</span>, un sogno che diventa realt&agrave;', '2018-01-04', '01:32:27', 'molto bene', 'admin'),
(6, 'La Recensione di <span lang="en">Assassin&rsquo;s Creed : Origins</span>, mummia o faraone?', '2018-01-04', '07:37:36', 'comento', 'admin'),
(7, 'La Recensione di <span lang="en">Call of Duty: WWII</span>, piedi in terra', '2018-01-04', '07:39:05', 'oggi Ã¨ un bel giorno 04/01', 'admin');
...
('<span lang="en">Assassin&rsquo;s Creed: Origins</span>', 'ACO.jpg', 'ACO0.jpg'),
('<span lang="en">Call of Duty: World War II</span>', 'CODWWII.jpg', 'CODWWII0.jpg'),
('<span lang="en">Crash Bandicoot: N.Sane Trilogy</span>', 'CBT.jpg', 'CBT0.jpg'),
('FIFA 18', 'FIFA18.jpg', 'FIFA180.jpg'),
('<span lang="en">The Legend of</span> Zelda: <span lang="en">Breath of the Wild</span>', 'ZBW.jpg', 'ZBW0.jpg'),
('<span lang="en">Need For Speed: Payback</span>', 'NFSPayback.jpg', 'NFSPayback0.jpg'),
('Super Mario <span lang="en">Odyssey</span>', 'SMO.jpg', 'SMO0.jpg'),
('<span lang="en">The Legend Of Zelda: A Link Between Worlds</span>', 'Zelda.jpg', 'Zelda0.jpg'),
('<span lang="en">The Sims</span> 3', 'Thesims3.jpg', 'Thesims30.jpg');
...
(1, '2017-11-30', 'Presentata <span lang="en">Xbox One</span> X ', 'Depaa', '<span lang="en">Xbox One</span> X &egrave;, anzitutto, un piccolo miracolo di ingegneria e progettazione. La <span lang="en">console</span> se ne esce dalla scatola pronta a stupire l&rsquo;utente grazie alle dimensioni estremamente contenute, addirittura pi&ugrave; ridotte della candida &ldquo;sorellina minore&rdquo;. Il <span lang="en">form factor</span> &egrave; simile a quello di <span lang="en">Xbox One</span> S: essenziale, pulito, squadrato, ma decisamente pi&ugrave; elegante rispetto a quello della versione &ldquo;fat&rdquo;. Il blocco centrale della macchina ne sovrasta uno pi&ugrave; piccolo, mettendo in risalto il vano del disco.
...
(2, '2017-12-02', '<span lang="en">The Legend Of</span> Zelda: <span lang="en">Breath Of The Wild</span>. Premiato come gioco dell&rsquo;anno!', 'Peachka',' Nuovo importante riconoscimento per <span lang="en">The Legend Of</span> Zelda: <span lang="en">Breath Of The Wild</span>.: questa volta &egrave; <span lang="en">GameSpot USA</span> a premiare l&rsquo;ultima avventura di <span lang="en">Link</span> con il prestigioso premio di <span lang="en">Game of the Year</span>, riservato al miglior gioco dell&rsquo;anno.
  ...
  Il gioco &rsquo; stato eletto <span lang="en">Game of the Year</span> ai <span lang="en">The Game Awards</span> dell&rsquo;8 dicembre scorso, riconoscimento importante, inoltre anche <span lang="en">Polygon</span> ha inserito <span lang="en">Zelda Breath of the Wild</span> nella Top 50 dell§&rsquo;anno che sta pr terminare.
...
(3, '2017-12-02', 'Uscir&agrave; presto il nuovo <span lang="en">God of War</span>', 'Depaa',' <span lang="en">Sony Interactive Entertainment</span> ha pubblicato un video di <span lang="en">God of War</span> dedicato ad Atreus, il figlio di Kratos, svelando nuovi dettagli e retroscena sulla storia del personaggio. 
  ...
  Tra le altre cose, apprendiamo che Atreus sar&agrave; in grado di ascoltare le voci degli animali nella propria testa, caratteristica che con ogni probabilit&agrave; troverà diverse applicazioni interessanti anche a livello di <span lang="en">gameplay</span>.
...
(4, '2017-12-02', 'Auguri di buone feste dalla redazione di <span lang="en">GamesGuide</span> ', 'Aiolos','Un altro anno giunge al termine, e noi della redazione di <span lang="en">GamesGuide</span> vogliamo augurarvi buone feste e qualche giorno di sano <span lang="en">relax</span> (magari in compagnia dei vostri videogiochi preferiti) in attesa di un promettente 2018. 
...
(5, '2017-12-02', 'AMD <span lang="en">Radeon Adrenalin Edition</span> 17.12.2 ora disponibili ', 'Depaa',' AMD ha pubblicato una nuova versione dei <span lang="en">driver</span> per le schede video dotate delle sue GPU. 
  AMD <span lang="en">Radeon Adrenalin Edition</span> 17.12.2 risolvono alcuni problemi riscontrati dagli utenti con alcuni giochi ed applicazioni, in particolare modo ARK <span lang="en">Survival Evolved<span lang="en">,<span lang="en"> Star Wars Battlefront</span> 2 e <span lang="en">Netflix</span>. 
  Non ci resta che augurare ai nostri lettori buon <span lang="en">download</span> e buon aggiornamento.', 0, 0, 1, 1, 0, 0, 0, 0, 'AMD.jpg'),

(6, '2017-12-02', '<span lang="en">Switch</span>: Nintendo ha rimosso NES Golf dal <span lang="en">firmware</span> della <span lang="en">console</span>', 'Peachka',' Come gi&agrave; saprete, diverso tempo fa era stata scoperta la presenza di un emulatore NES ed il titolo Golf all&rsquo;interno del <span lang="en">firmware</span> di <span lang="en">Switch</span>. 
...
(7, '2017-12-02', '<span lang="en">The Crew</span> 2: Sono aperte ore le iscrizioni alla Beta', 'Gionny','Nelle scorse ore <span lang="en">Ubisoft</span> ha ufficialmente aperto le iscrizioni alla fase Beta di <span lang="en">The Crew</span> 2 su <span lang="en">PlayStation</span> 4, <span lang="en">Xbox One</span> e PC.
  Per la registrazione &egrave; sufficiente recarsi a questo indirizzo, creare un <span lang="en">account Ubisoft</span> (o semplicemente effettuare il log in con quello gi&agrave; in vostro possesso), scegliere la piattaforma preferita e premere sul pulsante di conferma. 
  I giocatori selezionati riceveranno una <span lang="en"></span> pochi giorni prima dell&rsquo;inizio con tutte le informazioni necessarie per ottenere l&rsquo;accesso.
  Purtroppo, <span lang="en">Ubisoft</span> non ha ancora annunciato la data d&rsquo;inizio della fase di <span lang="en">testing</span>, n&egrave; tantomeno quella dell&rsquo;uscita del gioco. <span lang="en">The Crew</span> 2, inizialmente previsto per il 16 marzo 2018, &egrave; stato infatti rinviato dalla casa francese a data da destinarsi. 
  Il <span lang="en">team</span> di sviluppo sfrutter&agrave; i prossimi mesi per effettuare sessioni di testing aggiuntive e raccogliere il <span lang="en">feedback</span> dei giocatori. Il titolo si è mostrato l&rsquo;ultima volta nel mese di agosto, in occasione della <span lang="en">Gamescom</span> di Colonia.', 1, 1, 0, 0, 1, 0, 1, 1, 'TC2.jpg'),


(8, '2017-12-02', '<span lang="en">Level-5</span> sta lavorando a un grande progetto per il suo ventesimo anniversario ', 'Depaa','Il noto sviluppatore <span lang="en">Level-5 </span>avrebbe alcuni grandi piani per festeggiare il loro ventesimo anniversario. Secondo quanto rivelato da <span lang="ja">Akihiro Hino</span>, CEO di <span lang="en">Level-5</span>, la compagnia starebbe lavorando a un titolo molto importante come parte della celebrazione. 
  Nessun dettaglio sul gioco &egrave; ancora emerso <span lang="en">online</span>, ma vale la pena sottolineare che le parole di <span lang="ja">Hino</span> sono apparse nel corso di un&rsquo;intervista con <span lang="ja">Dengeki</span> <span lang="en">PlayStation</span>, cosa questa che presuppone un progetto destinato alle <span lang="en">console Sony</span> (PS4 in testa).  ', 0, 0, 0, 0, 1, 0, 0, 0, 'L5.jpg');
...
INSERT INTO `recensione` (`IDr`, `NomeGioco`, `AdminNick`, `Titolo`, `Testo`, `Data`, `Playstation3`, `Playstation4`, `Xbox360`, `XboxOne`, `NintendoDS`, `NintendoSwitch`, `Windows`, `Mac`) 
VALUES
(1, '<span lang="en">Assassin&rsquo;s Creed: Origins</span>', 'Aiolos', 
  'La Recensione di <span lang="en">Assassin&rsquo;s Creed : Origins</span>, mummia o faraone?',
  'Separare il suo nome dalle antipatie personali e dalla negativit&agrave; che fin troppo spesso lo circonda potrebbe essere una necessit&agrave; perch&egrave; molti giocatori ne comprendano il reale valore, eppure la serie <span lang="en">Assassin&rsquo;s Creed </span> possiede ancora oggi una rilevanza a cui buona parte delle altre saghe possono solo aspirare, nata da un brillante misto di accessibilit&agrave; e fascino storico. 
  ...
  Oggi, forti di una sessione di prova di qualche giorno a Parigi, cercheremo di capire con voi se l&rsquo;origine degli assassini rappresenta davvero un nuovo inizio per questa iconica serie.',
  '2017-10-27',
  0,1,0,1,0,0,1,0),

(2, '<span lang="en">Call of Duty: World War II</span>', 'Depaa', 
  'La Recensione di <span lang="en">Call of Duty: WWII</span>, piedi in terra.',
  'Se dovessimo guardare solamente i dati di vendita potremmo tranquillamente paragonare <span lang="en">Call of Duty</span> a una macchina inarrestabile, una di quelle vetture talmente perfette da tagliare sempre per prime il traguardo, nonostante intoppi e incidenti di percorso. 
  ...
  Qualche settimana fa siamo per&ograve; volati a Londra per affondare i denti sul pacchetto completo e oggi torniamo da voi con il verdetto finale per la produzione.',
  '2017-11-03',
  0,1,0,1,0,0,1,0),

(3, 'Super Mario <span lang="en">Odyssey</span>', 'admin',
  'La Recensione di Super Mario <span lang="en">Odyssey</span>',
  'Nonostante sia stato spesso definito come tale, Super Mario <span lang="en">Odyssey</span>, almeno in senso stretto, non &egrave; il seguito di Super Mario 64. 
  ...
  Si ispira all&rsquo;esplorazione del capostipite su Nintendo 64, ripropone le missioni tematiche di Super Mario <span lang="en">Sunshine</span>, eredita la varietà e gli scherzi gravitazionali di Super Mario <span lang="en">Galaxy</span>, e perfino dall&rsquo;ultimo Super Mario 3D <span lang="en">World</span>, teoricamente cos&igrave; diverso, riprende ritmo e abbondanza di contenuti.
  Insomma, per dirla alla <span lang="en">Tolkien</span>, &ldquo;un <span lang="en">platform</span> per domarli, un <span lang="en">platform</span> per trovarli, un <span lang="en">platform</span> per ghermirli e nell&rsquo;oscurità incatenarli&rdquo;.',
  '2017-10-27',
  0,0,0,0,0,1,0,0),

(4, '<span lang="en">The Legend of</span> Zelda: <span lang="en">Breath of the Wild</span> ','Peachka',
  'La Recensione di <span lang="en">The Legend of</span> Zelda: <span lang="en">Breath of the Wild</span> ',
  'Questo ultimo episodio di <span lang="en">The Legend of</span> Zelda è il gioco più grande e costoso della storia Nintendo: è stato sviluppato per cinque anni (dal 2012 al 2016) e ha richiesto, al culmine della lavorazione, l&rsquo;impegno di circa trecento persone, alcune delle quali tra l&rsquo;altro, provenienti da <span lang="en">Monolith Soft(Xenoblade X Chronicles). </span>
...
(4, 'Super Mario <span lang="en">Odyssey</span>', 'Nikocister'),
(3, 'FIFA 18', 'Mmasier'),
(5, '<span lang="en">The Legend Of Zelda: A Link Between Worlds</span>', 'Snordio'),
(4, 'Super Mario <span lang="en">Odyssey</span>', 'Drakex94'),
(1, '<span lang="en">Call of Duty: World War II</span>', 'DarkWarrior'),
(4, '<span lang="en">Need For Speed: Payback</span>', 'Nikocister'),
(4, '<span lang="en">Assassin&rsquo;s Creed: Origins</span>', 'Mmasier'),
(5, '<span lang="en">Crash Bandicoot: N.Sane Trilogy</span>', 'Snordio'),
(4, '<span lang="en">The Sims</span> 3', 'Drakex94'),
(1, '<span lang="en">Crash Bandicoot: N.Sane Trilogy</span>rilogy', 'DarkWarrior'),
(5, '<span lang="en">The Legend of</span> Zelda: <span lang="en">Breath of the Wild</span>', 'DarkWarrior');
...
(1, '<span lang="en">Assassin&rsquo;s Creed: Origins</span>', '2017-10-27', 'RPG', 'Avventura', NULL, 18, NULL, 'Ps4, XboxOne, Windows', 0,1,0,0,0,0,1,0,
'L&rsquo;Antico Egitto, sta scomparendo in una lotta spietata per il potere. Scopri oscuri segreti e miti dimenticati e vivi l&rsquo;inizio di tutto: le origini della Confraternita degli Assassini.
...
Scopri un nuovo sistema di combattimento e impossessati di molte nuove armi, ognuna diversa per rarità e caratteristiche.'),

(2, '<span lang="en">Call of Duty: World War II</span>', '2017-11-03', 'FPS', 'Azione', NULL, 18, NULL, 'Ps4, XboxOne, Windows', 0, 1, 0, 1, 0, 0, 1, 0, 'Un&rsquo;esperienza mozzafiato che porterà una nuova generazione nella Seconda Guerra Mondiale. Sbarca in Normandia e combatti in tutta Europa rivivendo leggendarie battaglie che hanno segnato il conflitto più sanguinoso della storia. Scopri il classico combattimento di <span lang="en">Call of Duty</span>, i legami del cameratismo e il cuore crudele della guerra.'),

(3, 'Super Mario <span lang="en">Odyssey</span>', '2017-10-27', 'Avventura', 'Azione', NULL, 10, NULL, 'NSwitch', 0, 0, 0, 0, 0, 1, 0, 0, 'Mario approda su Nintendo Switch con un&rsquo;avventura 3D senza precedenti! Questo fantastico gioco in <span lang="en">stile sandbox</span>; il primo dai tempi degli amatissimi Super Mario 64 del 1996 e Super Mario <span lang="en">Sunshine</span> del 2002, &egrave; pieno zeppo di segreti e sorprese! Mario pu&ograve; ora contare su tutta una serie di nuove mosse e abilit&agrave;, come lanci o salti che sfruttano il cappello. Pu&ograve; persino impossessarsi di personaggi e oggetti, per possibilit&agrave; di <span lang="en">gameplay</span> incredibili e mai sperimentate prima.'),

(4, '<span lang="en">The Legend of</span> Zelda: <span lang="en">Breath of the Wild</span>', '2017-03-03', 'Avventura', 'Azione', NULL, 18, NULL, 'NSwitch', 0, 0, 0, 0, 0, 1, 0, 0,'Dimentica tutto quello che sai sui giochi di <span lang="en">The Legend of Zelda</span> e immergiti in un mondo di scoperte, esplorazione e avventura in <span lang="en">The Legend of Zelda: Breath of the Wild</span>, il nuovo capitolo di questa amatissima serie. Attraversa campi, foreste e montagne mentre cerchi di capire cosa &egrave; successo al regno di Hyrule in questa enorme, straordinaria avventura.
...
(5, '<span lang="en">Need For Speed: Payback</span>', '2017-11-10', 'Sport', 'Azione', NULL, 12, NULL, 'Ps4, XboxOne, Windows', 0, 1, 0, 1, 0, 0, 1, 0, 'Sullo sfondo della corruzione di <span lang="en">Fortune Valley</span>, il desiderio di vendetta porta la tua banda a riunirsi per sconfiggere la Loggia, una spietata organizzazione che esercita il suo controllo sui casin&ograve;, i criminali e i poliziotti della citt&agrave;. In questo paradiso del gioco d&rsquo;azzardo, la posta in palio &egrave; alta e la Loggia ha sempre le carte vincenti in mano. Affronta diversi eventi nei panni di <span lang="en">Tyler, Mac e Jess</span>. Guadagnati il rispetto del sottobosco della <span lang="en">Valley</span> e gareggia nella sfida finale per sconfiggere la Loggia una volta per tutte.'),

(6, 'FIFA 18', '2017-09-29', 'Sport', 'Strategia', NULL, 18, NULL, 'Ps3, Ps4, Xbox360, XboxOne, NSwitch, Windows,', 1,1,1,1,0,1,1,0, 'FIFA 18 attenua il confine tra il mondo reale e virtuale dando vita a eroi, squadre e atmosfere del gioco pi&ugrave; bello del mondo. 
...
(7, '<span lang="en">The Legend Of Zelda: A Link Between Worlds</span>', '2013-11-22', 'Avventura', 'RPG', NULL, 12, NULL, 'NDS', 0, 0, 0, 0, 1, 0, 0, 0, '<span lang="en">The Legend of Zelda: A Link Between Worlds</span> introduce un set completamente nuovo di rompicapi e <span lang="en">dungeon</span>! Questa volta <span lang="en">Link</span> pu&ograve; anche muoversi sui muri come se fosse un dipinto. Questa possibilit&agrave; cambia completamente la tua prospettiva, permettendoti di pensare in una nuova dimensione e risolvere rompicapi prima impensabili. L&rsquo;ordine e il modo in cui ti cimenti con ciascun labirinto dipender&agrave; completamente da te. Incontrerai anche un nuovo personaggio, Lavio, che rappresenta la chiave verso il successo: nella sua bottega potrai affittare o acquistare oggetti,che ti saranno utili nel corso dell&rsquo;avventura.'),

(8, '<span lang="en">Crash Bandicoot: N.Sane Trilogy</span>', '2017-06-30', 'Piattaforma', 'Azione', 'Avventura', 7, NULL, 'Ps4', 0, 1, 0, 0, 0, 0, 0, 0, 'Il tuo marsupiale preferito, <span lang="en">Crash Bandicoot</span>, &egrave; tornato! Pi&ugrave; forte e pronto a scatenarsi con <span lang="en">N. Sane Trilogy game collection</span>. Ruota, salta, scatta e divertiti atttraverso le sfide e le avventure dei tre giochi da dove tutto &egrave; iniziato. Rivivi i migliori momenti con la grafica completamente rimasterizzata in HD!'),

(9, '<span lang="en">The Sims</span> 3', '2009-06-02', 'Simulazione', NULL, NULL, 13, NULL, 'Ps3, Xbox360, XboxOne, NDS, Windows, Mac', 1, 0, 1, 1, 1, 0, 1, 1, '<span lang="en">The Sims</span> 3 &egrave; un capolavoro di simulazione che ti d&agrave; la possibilit&agrave; di ipotizzare e vivere tutte le vite che ti pare. Crea tutti i personaggi che vuoi, ognuno diverso dall&rsquo;altro in quanto a caratteristiche fisiche e psicologiche, regalagli una casa e un mondo in cui vivere.E poi stai a vedere che succede. Con <span lang="en">The Sims</span> 3 non c&rsquo;&egrave; nulla di prevedibile e nulla di impossibile.');
...
--
ALTER TABLE `recensione`
  MODIFY `IDr` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
