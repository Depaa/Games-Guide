...
(4, '2017-12-02', 'Auguri di buone feste dalla redazione di GamesGuide ', 'Aiolos','Un altro anno giunge al termine, e noi della redazione di <span lang="en">Games&rsquo; Guide</span> vogliamo augurarvi buone feste e qualche giorno di sano <span lang="en">relax</span> (magari in compagnia dei vostri videogiochi preferiti) in attesa di un promettente 2018. 
...
(5, '2017-12-02', 'AMD Radeon Adrenalin Edition 17.12.2 ora disponibili ', 'Depaa',' <span lang="en"> <abbr title="Advanced Micro Devices">AMD</abbr> </span> ha pubblicato una nuova versione dei <span lang="en">driver</span> per le schede video dotate delle sue <span lang="en"> <abbr title="Graphics Processing Un">GPU</abbr> </span>. 
...
(6, '2017-12-02', 'Switch: Nintendo ha rimosso NES Golf dal firmware della console', 'Peachka',' Come gi&agrave; saprete, diverso tempo fa era stata scoperta la presenza di un emulatore <span lang="en"> <abbr title="Nintendo Entertainment System">NES</abbr> </span> ed il titolo Golf all&rsquo;interno del <span lang="en">firmware</span> di <span lang="en">Switch</span>. 
...
(6, 'FIFA 18', 'Gionny',
  ...
  'La modalit&agrave; che maggiormente ne ha beneficiato in FIFA 18 &egrave; il ritorno di <span lang="en">Hunter.</span> 
