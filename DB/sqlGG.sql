...
--
-- Host: 127.0.0.1
-- Creato il: Gen 03, 2018 alle 10:39
...
(16, 'ASDFYD', '123456789', 'asdfghjk', 'asdfghjk', '2000-02-02', 'sdfgh@asdf@it', 0, 0);

-- --------------------------------------------------------

--
-- Struttura della tabella `commentinotizie`
--
...
--
-- Dump dei dati per la tabella `commentinotizie`
--
...
--
-- Struttura della tabella `commentirecensione`
--
...
--
-- Dump dei dati per la tabella `commentirecensione`
--
...
--
-- Indici per le tabelle `commentinotizie`
--
...
--
-- Indici per le tabelle `commentirecensione`
--
...
--
-- AUTO_INCREMENT per la tabella `commentinotizie`
--
ALTER TABLE `commentinotizie`
  MODIFY `IDc` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `commentirecensione`
--
ALTER TABLE `commentirecensione`
  MODIFY `IDc` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
