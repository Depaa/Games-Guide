				...
				foreach($output as $campo => $row) {
					echo '<div class="scheda">';
						if (isset($_SESSION['userSession'])!="") {
							if($rowA['Admin']==1) {
								echo '<a id="contenutoPrincipale" href="deletethings.php?id='.$row['ID'].'&table=Videogiochi"><button class="deletebtnVID" type="submit" name="submitE">Elimina</button></a>';
								echo '<a href="deletethings.php?id='.$row['ID'].'&table=Videogiochi"><em class="fa fa-trash"></em></a>';
							}
						}
						echo '<h3>' .$row['Nome']. '</h3>';
