<?php
	...
	if(isset($_POST['submitRP'])) {
		...
		$ord = " ORDER BY Data DESC LIMIT 100 OFFSET 1";
		...
		$query = "SELECT Recensione.NomeGioco, IDr, AdminNick, Testo, Titolo, Data, MenuImg FROM Recensione JOIN Immagini ON Recensione.NomeGioco=Immagini.NomeGioco $wh $ord";
	...
	if(isset($_POST['submitNP'])) {
		...
		$query = "SELECT ID, AdminNick, Testo, Titolo, Data, MenuImg FROM Notizie  $wh $ord";
