<?php
	...
	if(isset($_POST['submitG'])) 
	{
		...
		if(empty($_POST["gname"]))
			$error_messageG = "All Fields are required1";
		else if(empty($_POST["gdata"]))
			$error_messageG = "All Fields are required2";
		else if(empty($_POST["ggenere1"]))
			$error_messageG = "All Fields are required3";
		else if(empty($_POST["gpegi"]))
			$error_messageG = "All Fields are required4";
		else if(empty($_POST["gdisp"]))
			$error_messageG = "All Fields are required5";
		else if(empty($_POST["gdesc"]))
			$error_messageG = "All Fields are required6";
		else {
	...
	if(isset($_POST['submitR']))
	{
		...
		else 
		{
			...
			$query_controllo= "SELECT * FROM Giochi WHERE Giochi.nome = '$nome_gioco';";
