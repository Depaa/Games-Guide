	...
	$outputN = $conn->query($queryN) or die("Errore nella query MySQL: ".$conn->error);
		...
		echo '<div class="navbar">';
			...
			echo '<div class="dropdown">';
				echo '<a href="Notizie.php"><button class="dropbtn">Notizie<em class="fa fa-caret-down"></em></button></a>';
			...
			echo '<div class="dropdown">';
				echo '<a href="Recensione.php"><button class="dropbtn">Recensioni<em class="fa fa-caret-down"></em></button></a>';
				echo '<div class="dropdown-content">';
			...
			echo '<div class="dropdown">';
				echo '<a href="Videogiochi.php"><button class="dropbtn">Giochi<em class="fa fa-caret-down"></em></button></a>';
				echo '<div class="dropdown-content">';
		...
		echo '<!--inizio div per menu mobile-->';
			echo '<div class="sandwich">';
				...
				echo '<ul class="menu collapse">';
					echo '<li><a href="index.php">Home</a><em class="fa fa-home"></em></li>';
