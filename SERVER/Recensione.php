<?php
	...
	$query1 = "SELECT Recensione.NomeGioco, ID, AdminNick, Testo, Titolo, Data, MenuImg FROM Recensione JOIN Immagini ON Recensione.NomeGioco=Immagini.NomeGioco ORDER BY Data DESC LIMIT 1";
	$query = "SELECT Recensione.NomeGioco, ID, AdminNick, Testo, Titolo, Data, MenuImg FROM Recensione JOIN Immagini ON Recensione.NomeGioco=Immagini.NomeGioco ORDER BY Data DESC LIMIT 100 OFFSET 1";
...
<!-- SELECT NomeGioco, AdminNick, Testo, Titolo, Data, MenuImg -->
