<?php
	...
	$query = "SELECT Recensione.NomeGioco, ID, AdminNick, Testo, Titolo, Data, MenuImg FROM Recensione JOIN Immagini ON Recensione.NomeGioco=Immagini.NomeGioco ORDER BY Data DESC";
	//$conn = connessione();
