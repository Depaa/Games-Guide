...
(1, 'Presentata Xbox One X ', '2017-11-30', '10:30:00', 'La nuova Xbox One X spacca, è molto più performante di tutte le console Sony, sommate tra loro ovviamente ;) e poi, diciamoci la verità, le esclusive della sony non sono nemmeno così carine :sad:', 'Nikocister'),
...
(1, '2017-11-30', 'Presentata Xbox One X ', 'Depaa', '<span lang="en">Xbox One</span> X &egrave;, anzitutto, un piccolo miracolo di ingegneria e progettazione. La <span lang="en">console</span> se ne esce dalla scatola pronta a stupire l&rsquo;utente grazie alle dimensioni estremamente contenute, addirittura pi&ugrave; ridotte della candida &ldquo;sorellina minore&rdquo;. Il <span lang="en">form factor</span> &egrave; simile a quello di <span lang="en">Xbox One</span> S: essenziale, pulito, squadrato, ma decisamente pi&ugrave; elegante rispetto a quello della versione &ldquo;fat&rdquo;. Il blocco centrale della macchina ne sovrasta uno pi&ugrave; piccolo, mettendo in risalto il vano del disco.
...
(2, '2017-12-02', 'The Legend Of Zelda: Breath Of The Wild. Premiato come gioco dell&rsquo;anno!', 'Peachka',' Nuovo importante riconoscimento per <span lang="en">The Legend Of</span> Zelda: <span lang="en">Breath Of The Wild</span>.: questa volta &egrave; <span lang="en">GameSpot USA</span> a premiare l&rsquo;ultima avventura di <span lang="en">Link</span> con il prestigioso premio di <span lang="en">Game of the Year</span>, riservato al miglior gioco dell&rsquuo;anno.
  ...
  Non ci resta dunque che attendere di saperne di pi&ugrave; sul nuovo capitolo della saga.', 0, 0, 0, 1, 0, 0, 0, 0, 'XboxOneX.jpg'),

(3, '2017-12-02', 'Uscir&agrave; presto il nuovo God of War', 'Depaa',' <span lang="en">Sony Interactive Entertainment</span> ha pubblicato un video di <span lang="en">God of War</span> dedicato ad Atreus, il figlio di Kratos, svelando nuovi dettagli e retroscena sulla storia del personaggio. 
  ...
  Nell&rsquo;attesa che il nuovo <span lang="en">God of War</span> venga pubblicato in esclusiva su <span lang="en">PlayStation</span> 4 nel corso del 2018, vi riproponiamo gli ultimi <span lang="en">screenshot</span> del gioco mostrati nella giornata di ieri. ', 0, 0, 0, 0, 0, 0, 0, 1, 'XboxOneX.jpg'),

(4, '2017-12-02', 'Auguri di buone feste dalla redazione di GamesGuide ', 'Aiolos','Un altro anno giunge al termine, e noi della redazione di <span lang="en">GamesGuide</span> vogliamo augurarvi buone feste e qualche giorno di sano <span lang="en">relax</span> (magari in compagnia dei vostri videogiochi preferiti) in attesa di un promettente 2018. 
  ...
  All&rsquo;orizzonte ci sono tante nuove idee, rubriche, approfondimenti e contenuti che speriamo apprezzerete. Nel frattempo...Buone feste!', 1, 1, 1, 1, 1, 1, 1, 1, 'XboxOneX.jpg'),

(5, '2017-12-02', 'AMD Radeon Adrenalin Edition 17.12.2 ora disponibili ', 'Depaa',' AMD ha pubblicato una nuova versione dei <span lang="en">driver</span> per le schede video dotate delle sue GPU. 
  ...
  Non ci resta che augurare ai nostri lettori buon <span lang="en">download</span> e buon aggiornamento.', 0, 0, 1, 1, 0, 0, 0, 0, 'XboxOneX.jpg'),

(6, '2017-12-02', 'Switch: Nintendo ha rimosso NES Golf dal firmware della console', 'Peachka',' Come gi&agrave; saprete, diverso tempo fa era stata scoperta la presenza di un emulatore NES ed il titolo Golf all&rsquo;interno del <span lang="en">firmware</span> di <span lang="en">Switch</span>. 
  ...
  La sua rimozione lascia pensare che si potesse trattare solo di codice di prova lasciato erroneamente dai progettisti del sistema.', 0, 0, 0, 1, 0, 0, 0, 0, 'XboxOneX.jpg'),

(7, '2017-12-02', 'The Crew 2: Sono aperte ore le iscrizioni alla Beta', 'Gionny','Nelle scorse ore <span lang="en">Ubisoft</span> ha ufficialmente aperto le iscrizioni alla fase Beta di <span lang="en">The Crew</span> 2 su <span lang="en">PlayStation</span> 4, <span lang="en">Xbox One</span> e PC.
...
VALUES
(1, 'Assassin&rsquo;s Creed: Origins', 'Aiolos', 
  'La Recensione di Assassin&rsquo;s Creed : Origins, mummia o faraone?',
...
(2, 'Call of Duty: World War II', 'Depaa', 
  'La Recensione di Call of Duty: WWII, piedi in terra.',
...
(3, 'Super Mario Odyssey', 'admin',
  'La Recensione di Super Mario Odyssey',
...
(4, 'The Legend of Zelda: Breath of the Wild','Peachka',
  'La Recensione di The Legend of Zelda: Breath of the Wild',
...
(5, 'Need For Speed: Payback', 'Aiolos',
  'La Recensione di Need For Speed: Payback, La vendetta &egrave; servita!',
...
(7, 'The Legend Of Zelda: A Link Between Worlds', 'Peachka',
  'La Recensione di The Legend Of Zelda: A Link Between Worlds. Un remake con qualcosa di pi&ugrave;!',
...
(8, 'Crash Bandicoot: N.Sane Trilogy','Aiolos',
  'La Recensione di Crash Bandicoot, un sogno che diventa realt&agrave;',
...
(4, 'Super Mario Odyssey', 'Drakex94'),
(1, 'Call of Duty: World War II', 'DarkWarrior'),
(4, 'Need For Speed: Payback', 'Nikocister'),
(4, 'Assassin&rsquo;s Creed: Origins', 'Mmasier'),
(5, 'Crash Bandicoot: N.Sane Trilogy', 'Snordio'),
(4, 'The Sims 3', 'Drakex94'),
(1, 'Crash Bandicoot: N.Sane Trilogy', 'DarkWarrior'),
(5, 'he Legend of Zelda: Breath of the Wild', 'DarkWarrior');
...
(1, 'Assassin&rsquo;s Creed: Origins', '2017-10-27', 'RPG', 'Avventura', NULL, 18, NULL, 'Ps4, XboxOne, Windows', 0,1,0,0,0,0,1,0,
...
(7, 'The Legend Of Zelda: A Link Between Worlds', '2013-11-22', 'Avventura', 'RPG', NULL, 12, NULL, 'NDS', 0, 0, 0, 0, 1, 0, 0, 0, '<span lang="en">The Legend of Zelda: A Link Between Worlds</span> introduce un set completamente nuovo di rompicapi e <span lang="en">dungeon</span>! Questa volta <span lang="en">Link</span> pu&ograve; anche muoversi sui muri come se fosse un dipinto. Questa possibilit&agrave; cambia completamente la tua prospettiva, permettendoti di pensare in una nuova dimensione e risolvere rompicapi prima impensabili. L&rsquo;ordine e il modo in cui ti cimenti con ciascun labirinto dipender&agarve; completamente da te. Incontrerai anche un nuovo personaggio, Lavio, che rappresenta la chiave verso il successo: nella sua bottega potrai affittare o acquistare oggetti,che ti saranno utili nel corso dell&rsquo;avventura.'),

(8, 'Crash Bandicoot: N.Sane Trilogy', '2017-06-30', 'Piattaforma', 'Azione', 'Avventura', 7, NULL, 'Ps4', 0, 1, 0, 0, 0, 0, 0, 0, 'Il tuo marsupiale preferito, <span lang="en">Crash Bandicoot</span>, &egrave; tornato! Pi&ugrave; forte e pronto a scatenarsi con <span lang="en">N. Sane Trilogy game collection</span>. Ruota, salta, scatta e divertiti atttraverso le sfide e le avventure dei tre giochi da dove tutto &egrave; iniziato. Rivivi i migliori momenti con la grafica completamente rimasterizzata in HD!'),

(9, 'The Sims 3', '2009-06-02', 'Simulazione', NULL, NULL, 13, NULL, 'Ps3, Xbox360, XboxOne, NDS, Windows, Mac', 1, 0, 1, 1, 1, 0, 1, 1, '<span lang="en">The Sims</span> 3 &egrave; un capolavoro di simulazione che ti d&agrave; la possibilit&agrave; di ipotizzare e vivere tutte le vite che ti pare. Crea tutti i personaggi che vuoi, ognuno diverso dall&rsquo;altro in quanto a caratteristiche fisiche e psicologiche, regalagli una casa e un mondo in cui vivere.E poi stai a vedere che succede. Con <span lang="en">The Sims</span> 3 non c&rsquo;&egrave; nulla di prevedibile e nulla di impossibile.');
